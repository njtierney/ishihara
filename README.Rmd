...
The goal of ishihara is to create an [Ishihara test](https://en.wikipedia.org/wiki/Ishihara_test), which can help assess colourblindness.
...
I had an idea on how I could maybe create this kind of figure in R, using 
spatial tools. The general process is:
...
```{r ishihara-example, fig.show="hold", out.width = "20%"}
set.seed(2020-05-10)
